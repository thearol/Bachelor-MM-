...
#                    
                    ...
                    if employee.gender == "men": #if own gender equals the gender which is favored, do this
                        ...
                        employee.rating = previous_rating + (new_rating *0.1* current_conf_M + new_rating *0.9)* current_bias_M
                    else:
                        previous_rating = employee.rating/2
                        # Saves updated rating to Employee object                        
                        employee.rating = previous_rating + (new_rating *0.1* current_conf_F + new_rating *0.9)* current_bias_F
