...
long_data_db <- merge(data_j, mdata, by = c("SubjectID_unique", "Trial")) #Insert NAs on trials lower than 10
...
sensitivity_scores <- distinct(long_data_db, SubjectID_unique, Side, Intercept, Slope, Sensitivity_roll)
