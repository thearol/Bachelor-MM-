...
data_db <- data_db %>%
  mutate(diff = ifelse(Block == "blå", abs(Prop_blue_image_2 - Prop_blue_image_1), ifelse(Block == "rød", abs(Prop_red_image_2 - Prop_red_image_1), ifelse(Block == "grøn", abs(Prop_green_image_2 - Prop_green_image_1), ifelse(Block == "gul", abs(Prop_yellow_image_2 - Prop_yellow_image_1), NA)))))
...
disagree_db <- na.omit(data_db)

```

```{r save clean data files}
