...
data_db_all <- read.csv("data_db_all.csv")
```
...
#prior predictive check
model_db4_prior <- brm(leader_behavior ~ 0 + conf_dif*Leader_gender:Follower_gender+ (0 + skill_dif_roll_c:Follower_gender | SubjectID), 
                       prior = prior_db4, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db4 <- brm(leader_behavior ~ 0 +conf_dif*Leader_gender:Follower_gender+ (0 + skill_dif_roll_c:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db4,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
