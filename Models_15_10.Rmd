...
data_db <- read.csv("decision_bias/disagree_sensitivity_db_long.csv")[, 2:40]
```
...
```{r model without gender, both follower and leader,3 }
#Defining priors
prior_db3 <- c(
  prior(normal(0,.2),class="b"),
  prior(normal(0,.1),class="sd")
...
#prior predictive check
model_db3_prior <- brm(leader_behavior ~ 0 + conf_dif*skill_dif+ (0 + skill_dif:Follower_gender | SubjectID), 
                       prior = prior_db3, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db3 <- brm(leader_behavior ~ 0 + conf_dif*skill_dif+ (0 + skill_dif:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db3,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
...
#prior predictive check
model_db4_prior <- brm(leader_behavior ~ 0 + skill_dif*Leader_gender:Follower_gender+ (0 + skill_dif:Follower_gender | SubjectID), 
                       prior = prior_db4, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db4 <- brm(leader_behavior ~ 0 +skill_dif*Leader_gender:Follower_gender+ (0 + skill_dif:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db4,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
...
```{r model without skill difference, 5}
#Defining priors
prior_db5 <- c(
  prior(normal(0,.2),class="b"),
  prior(normal(0,.1),class="sd")
...
#prior predictive check
model_db5_prior <- brm(leader_behavior ~ 0 + conf_dif*Leader_gender:Follower_gender+ (0 + skill_dif:Follower_gender | SubjectID), 
                       prior = prior_db5, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db5 <- brm(leader_behavior ~ 0 +conf_dif*Leader_gender:Follower_gender+ (0 + skill_dif:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db5,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
...
#prior predictive check
model_db6_prior <- brm(leader_behavior ~ 0 + conf_dif*skill_dif*Follower_gender + (0 + skill_dif:Follower_gender | SubjectID), 
                       prior = prior_db6, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db6 <- brm(leader_behavior ~ 0 + conf_dif*skill_dif*Follower_gender + (0 + skill_dif:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db6,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
...
```{r model with only leader gender, 7}
#Defining priors
prior_db7 <- c(
  prior(normal(0,.2),class="b"),
  prior(normal(0,.1),class="sd")
...
#prior predictive check
model_db7_prior <- brm(leader_behavior ~ 0 + conf_dif*skill_dif*Leader_gender:Follower_gender + (0 + skill_dif:Follower_gender | SubjectID), 
                       prior = prior_db7, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db7 <- brm(leader_behavior ~ 0 + conf_dif*skill_dif*Leader_gender:Follower_gender + (0 + skill_dif:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db7,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
