...
model_db1_prior <- brm(leader_behavior ~ 0 + Leader_gender:Follower_gender + (0 + skill_dif_c:Follower_gender | SubjectID), 
                       prior = prior_db1, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db1 <- brm(
  leader_behavior ~ 0 + Leader_gender : Follower_gender + ( 0 + skill_dif_c : Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db1,
  sample_prior=T,
...
#prior predictive check
model_db2_prior <- brm(leader_behavior ~ 0 + conf_dif_c*skill_dif_c*Leader_gender:Follower_gender + (0 + skill_dif_c:Follower_gender | SubjectID), 
                       prior = prior_db2, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db2 <- brm(leader_behavior ~ 0 + conf_dif_c*skill_dif_c*Leader_gender:Follower_gender + (0 + skill_dif_c:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db2,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
...
#prior predictive check
model_db3_prior <- brm(leader_behavior ~ 0 + skill_dif*Leader_gender:Follower_gender+ (0 + skill_dif:Follower_gender | SubjectID), 
                       prior = prior_db3, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db3 <- brm(leader_behavior ~ 0 +skill_dif*Leader_gender:Follower_gender+ (0 + skill_dif:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db3,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
...
#prior predictive check
model_db4_prior <- brm(leader_behavior ~ 0 + conf_dif*Leader_gender:Follower_gender+ (0 + skill_dif:Follower_gender | SubjectID), 
                       prior = prior_db4, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db4 <- brm(leader_behavior ~ 0 +conf_dif*Leader_gender:Follower_gender+ (0 + skill_dif:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db4,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
...
```{r model excluding skill dif, replication of effects from last year, 5}
...
#prior predictive check
model_db5_prior <- brm(leader_behavior ~ 0 + Leader_gender:Follower_gender + (0 + skill_dif_roll_c:Follower_gender | SubjectID), 
                       prior = prior_db5, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
#prior predictive check
model_db6_prior <- brm(leader_behavior ~ 0 + conf_dif_c*skill_dif_roll_c*Leader_gender:Follower_gender + (0 + skill_dif_roll_c:Follower_gender | SubjectID), 
                       prior = prior_db6, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db6 <- brm(leader_behavior ~ 0 + conf_dif_c*skill_dif_roll_c*Leader_gender:Follower_gender + (0 + skill_dif_roll_c:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db6,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
...
#prior predictive check
model_db7_prior <- brm(leader_behavior ~ 0 + skill_dif_roll_c*Leader_gender:Follower_gender+ (0 + skill_dif_roll_c:Follower_gender | SubjectID), 
                       prior = prior_db7, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
model_db7 <- brm(leader_behavior ~ 0 +skill_dif_roll_c*Leader_gender:Follower_gender+ (0 + skill_dif_roll_c:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db7,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
...
```{r model without skill difference, 8}
#Defining priors
prior_db8 <- c(
  prior(normal(0,.2),class="b"),
  prior(normal(0,.1),class="sd")
...
#prior predictive check
model_db8_prior <- brm(leader_behavior ~ 0 + conf_dif*Leader_gender:Follower_gender+ (0 + skill_dif_roll_c:Follower_gender | SubjectID), 
                       prior = prior_db8, 
                       data = data_db, 
                       sample_prior = "only",
                       iter = 4000, 
...
pp_check(model_db8_prior, nsamples = 100)


model_db8 <- brm(leader_behavior ~ 0 +conf_dif*Leader_gender:Follower_gender+ (0 + skill_dif_roll_c:Follower_gender | SubjectID),
  data = data_db,
  prior = prior_db8,
  sample_prior=T,
  family = "bernoulli", #As we had a binary outcome, we set this to "bernoulli"
...
##Waic
```{r waic}
waic(model_db1, model_db2, model_db3, model_db4, model_db5, model_db6, model_db7, model_db8)
